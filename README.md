...
This v2.7.1 standalone package uses the included offline seed and browser localStorage for menu, inventory, sales, held orders, expenses, recipes and settings. It does not require PostgreSQL, Netlify CLI, or a local server.
